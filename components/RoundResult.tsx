      ...
      <div className="app-content app-content-scroll">
        <div className="page max-w-lg">
          ...
          <div className="surface-card p-4 sm:p-5 mb-4">
            <p className="text-center text-[3.2rem] sm:text-[4.6rem] lg:text-[5.4rem] font-black mb-3 leading-[0.95]">{verse.book} {verse.chapter}:{verse.verse}</p>
          ...
          <div className="surface-card p-4 sm:p-5 mb-4">
            ...
            <div className="flex justify-between items-center text-[2.15rem] sm:text-[2.4rem] py-3 border-t border-[var(--line)] mt-1 font-black">
              <span>Total</span>
              <span>{score}</span>
            </div>
          </div>
          ...
          <div className="surface-card p-4 sm:p-5 mb-6">
            ...
            <div className="flex justify-between items-center text-[2.15rem] sm:text-[2.4rem] py-3 mt-1 border-t border-[var(--line)] font-black">
